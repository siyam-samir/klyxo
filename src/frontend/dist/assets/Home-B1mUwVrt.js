import { c as createLucideIcon, j as jsxRuntimeExports, r as reactExports, u as useKlyxoStore, A as AnimatePresence, m as motion } from "./index-C8yyXDgB.js";
import { P as Play, C as ChevronLeft, M as MovieCard } from "./MovieCard-Cm--8EtN.js";
import { u as useTrending, a as usePopularMovies, b as useNowPlayingMovies, c as usePopularTVShows } from "./use-tmdb-BZZdlqsi.js";
import { g as getMediaTitle, a as getBackdropUrl, b as getImageUrl } from "./tmdb-widsgkgP.js";
/**
...
function HeroCarousel({ items }) {
  ...
  if (heroes.length === 0) return /* @__PURE__ */ jsxRuntimeExports.jsx(HeroSkeleton, {});
  const hero = heroes[current];
  const title = getMediaTitle(hero);
  const rating = hero.vote_average;
  const yearStr = "release_date" in hero ? (_a = hero.release_date) == null ? void 0 : _a.slice(0, 4) : (_b = hero.first_air_date) == null ? void 0 : _b.slice(0, 4);
  const heroVideos = hero.videos;
  const trailerKey = ((_c = heroVideos == null ? void 0 : heroVideos.results.find(
    (v) => v.type === "Trailer" && v.site === "YouTube"
  )) == null ? void 0 : _c.key) ?? null;
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "section",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(AnimatePresence, { mode: "wait", initial: false, custom: direction, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          motion.div,
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "div",
                {
                  ...
                  style: {
                    background: "radial-gradient(ellipse at center bottom, rgba(80,0,0,0.5) 0%, transparent 60%)"
                  }
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[#050505] via-[#050505]/50 to-transparent pointer-events-none" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 left-0 w-1/4 bg-gradient-to-r from-[#050505] to-transparent pointer-events-none" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-y-0 right-0 w-1/4 bg-gradient-to-l from-[#050505] to-transparent pointer-events-none" })
            ]
          },
          current
        ) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative h-full flex flex-col justify-end px-5 pb-14 md:px-10 md:pb-20 lg:px-14 max-w-4xl", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            motion.h1,
            {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-px h-4 bg-foreground/20", "aria-hidden": "true" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                ...
                yearStr && /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            motion.div,
            {
              ...
              children: [
                ...
                trailerKey && /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "button",
                  {
                    type: "button",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: heroes.map((heroItem, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "button",
              {
                type: "button",
                role: "tab",
                ...
                className: `h-1.5 rounded-full transition-all duration-300 ${i === current ? "w-6 bg-[#E2B159]" : "w-1.5 bg-foreground/30 hover:bg-[#E2B159]/50"}`
              },
              heroItem.id
            ))
          }
...
function HeroSkeleton() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      style: { height: "clamp(60vh, 70vh, 80vh)" },
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-20 left-8 space-y-3", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: items.map((item) => {
              const posterSrc = item.posterPath ? getImageUrl(item.posterPath, "w185") : "/assets/images/placeholder.svg";
              return /* @__PURE__ */ jsxRuntimeExports.jsxs(
                motion.div,
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative aspect-[2/3] overflow-hidden", children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 bg-gradient-to-t from-[#050505]/80 to-transparent" })
                    ] }),
                    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-2", children: [
                      ...
                      item.episodeInfo && /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "p",
                        {
                          className: "text-[9px] text-muted-foreground mb-1.5 truncate",
                          style: { fontFamily: "Share Tech Mono, monospace" },
                          children: item.episodeInfo
                        }
                      ),
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
...
function CardGrid({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4", children: isLoading ? Array.from({ length: 10 }).map((_, i) => (
    // biome-ignore lint/suspicious/noArrayIndexKey: skeleton placeholders indexed intentionally
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[2/3] rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full h-full" }) }, i)
  )) : items.slice(0, 20).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(MovieCard, { item, type }, `${type}-${item.id}`)) });
}
function MediaSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.section,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(CardGrid, { items: items ?? [], type, isLoading })
      ]
    }
  );
}
function TrendingSection({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    motion.section,
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Trending Now" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-3 md:gap-4", children: isLoading ? Array.from({ length: 10 }).map((_, i) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: skeleton placeholders indexed intentionally
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "aspect-[2/3] rounded-lg overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Skeleton, { className: "w-full h-full" }) }, i)
        )) : (items ?? []).slice(0, 20).map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          MovieCard,
          {
            item,
            type: item.media_type === "tv" ? "tv" : "movie"
          },
          `trend-${item.media_type}-${item.id}`
        )) })
      ]
    }
  );
...
function HomePage() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      "data-ocid": "home-page",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(HeroCarousel, { items: trendingItems }),
